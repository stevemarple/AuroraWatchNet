...
\newcommand{\documentAttribution}{``AuroraWatchNet magnetometer
  manual. Steve R. Marple, Lancaster University. \gitCommitYear.''}

\typeout{Job is \jobname}
%%\ifthenelse{\equal{\detokenize{calunium-manual}}{\jobname}}{%
...
\expandafter\ifstrequal\expandafter{\jobname}{raspi-mag-manual}{%
  \typeout{Making Raspberry Pi manual}%
  \def\raspiMagManual{}
}{%
  \typeout{Not Raspberry Pi manual!}
}
