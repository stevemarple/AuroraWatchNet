...
Remove the Wolfram repository from the package source list. As user
\rootUser
\begin{Cmd}
...
A newer version of the \code{numpy} library is required for
\code{auroraplot}. As user \rootUser

\todo[Have numpy .deb file stored somewhere with instructions for
download.]
\begin{Cmd}
