...
As user \rootUser
\begin{Cmd}
apt install screen git git-doc git-man \textbackslash
    ...
    avahi-daemon dnsutils i2c-tools python3-smbus python3-smbus \textbackslash
    ntp ntpstat
\end{Cmd}
...
\ifdef{\usesMicrocontroller}{%
  %%% Raspbbery Pi Private Network
  \input{raspberry-pi-private-network}
}{}
