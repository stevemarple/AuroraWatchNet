...
\ifdef{\caluniumMagManual}{%
  \protect\todo[Systems which use the Calunium microcontroller should disable
  the login shell and enable the serial interface.]%
}{}

\ifdef{\raspiMagManual}{%
  \protect\todo[For systems where the sensor unit is connected directly to the
  Raspberry Pi the \protect\itwoc\ interface must be enabled.]%
}{}
...
\ifdef{\caluniumMagManual}{%
  \IncludeShellFileVerb{git-clone-cmds-calunium-mag.sh}%
}{}

\ifdef{\raspiMagManual}{%
  \IncludeShellFileVerb{git-clone-cmds-raspi-mag.sh}%
}{}
...
\ifdef{\caluniumMagManual}{%
  \input{raspberry-pi-setup-config-calunium-mag.tex}%
}{}

\ifdef{\raspiMagManual}{%
  \input{raspberry-pi-setup-config-raspi-mag.tex}%
}{}
...
%%% be used.
\ifdef{\caluniumMagManual}{%
  \IncludeShellFileVerb{use-awnetd-crontab.sh}%
}{}%
\ifdef{\raspiMagManual}{%
  \IncludeShellFileVerb{use-raspimagd-crontab.sh}%
}{}
