...
Find the lines which start \filename{server} and a insert \filename{#}
at the beginning of the line to comment them out. Insert a similar
line whihc begins with the word \filename{server} but with your own
\ntp\ server hostname. Your network adminstrator should be able to
provide this information. Finally restart \ntp; as user \rootUser
\begin{Cmd}
