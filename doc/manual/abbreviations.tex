...
\abbrev{\gpio}{GPIO}{general purpose input\slash output}
\abbrev{\gnss}{GNSS}{global navigation satellite system}
...
\abbrev{\lsb}{LSB}{least-significant bit}
\abbrev{\mac}{MAC}{media access control}
\newcommand{\macAddress}{\mac\ address}
\abbrev{\mdfive}{MD5}{message digest 5}
\abbrev{\msb}{MSB}{most-significant bit}
\abbrev{\nfs}{NFS}{network file system}
\abbrev{\nmea}{NMEA}{National Marine Electronics Association (data format)}
