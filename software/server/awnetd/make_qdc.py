...
# Check timezone set appropriately to get intended np.datetime64 behaviour.
...
while t1 < end_time:
    ...
    if args.plot:
        mag_qdc = ap.magdata.load_qdc(network, site, t1)
        ...
        mag_data = ap.load_data(network, site, 'MagData', t1, t2)
        if mag_data is not None:
            mag_qdc = mag_data.make_qdc(smooth=True)
    
            archive, ad = ap.get_archive_details(network, site, 'MagQDC', 
