...
#define EEPROM_RIO_NUM_COLS 0x101
#define EEPROM_RIO_NUM_COLS_SIZE 1
#define EEPROM_RIO_NUM_COLS_MAX 8
...
#define EEPROM_RIO_SCAN_PINS 0x112
#define EEPROM_RIO_SCAN_PINS_SIZE 3

#define EEPROM_RIO_PRESAMPLE_DELAY_MS 0x115
